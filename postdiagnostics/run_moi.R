...
moi_dir <- file.path("/home", "nikki", "Documents", "confluence", "workspace",
                      "diagnostics", "post_data", "input", "moi", fsep=.Platform$file.sep)
output_dir <- file.path("/home", "nikki", "Documents", "confluence", "workspace",
                        "diagnostics", "post_data", "output", "basin", fsep=.Platform$file.sep)
